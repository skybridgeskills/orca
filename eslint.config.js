...
export default ts.config(
	...
	// flat-config migration.
	{
		ignores: [
			...
			'.svelte-kit/**',
			'.vercel/**',
			// Entire directory is auto-generated by inlang paraglide-js (its own
			// .gitignore/.prettierignore ignore everything); don't lint it.
			'src/lib/i18n/**',
			// Inlang manages project.inlang cache/metadata; only settings.json is source.
			'project.inlang/**',
	...
	...svelte.configs.prettier,
	{
		...
		rules: {
			...
			'no-undef': 'off',
			// Align with @repo/config-eslint; existing codebase uses `any` in several places.
