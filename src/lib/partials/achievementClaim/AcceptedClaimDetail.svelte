...
{#if existingBadgeClaim?.claimStatus === "ACCEPTED"}
  <div
    class="max-w-2xl flex justify-between items-center mt-6 border-t border-b pt-5"
  >
...
>
  <p class="text-center text-gray-500 dark:text-gray-400">
    ...
    <a
      ...
      target="_blank">Credential Handler API (CHAPI)</a
