...
<nav class="bg-white border-gray-200 rounded dark:bg-gray-800">
  ...
  <div class="max-w-7xl mx-auto">
    <div class="flex flex-wrap justify-between items-center mx-auto">
      <div
        class="max-sm:container w-full md:w-auto max-md:mx-auto px-2 sm:px-4 py-2.5"
      >
      ...
      >
        ...
        >
          ...
          <NavItem href="/about" title={m.about()} />
          {#if !$session?.id}
          ...
          {:else}
            ...
            <li class="hidden md:block">
              ...
              <!-- Popup menu -->
              <PopupMenu
                bind:open={profileDropdownExpanded}
            ...
            <li class="md:hidden">
              ...
              >
                <button
                  type="submit"
                  class="text-md text-gray-700 dark:text-gray-400"
                  >{m.logOutCTA()}</button
                >
              </form>
            </li>
