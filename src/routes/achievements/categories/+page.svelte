...
<form id="createCategoryForm" method="POST" action="?/create" />
<form id="updateCategoryForm" method="POST" action="?/update" />
<form id="deleteCategoryForm" method="POST" action="?/delete">
	<input
